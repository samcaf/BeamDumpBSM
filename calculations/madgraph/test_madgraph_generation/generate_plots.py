...
def main():
    ...
    process_dir = '../../processes/test_madgraph_generation/'
    num_runs = 5
    ...
    labels = {'run_01': r'$m_\phi=10$ GeV',
              'run_02': r'$m_\phi=20$ GeV',
              'run_03': r'$m_\phi=50$ GeV',
              'run_04': r'$m_\phi=100$ GeV',
              'run_05': r'$m_\phi=200$ GeV'}
