...
C     
C     Process: mu- ns > mu- ns v WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,1),I=1,5) / 1, 0,-1, 0,-1/
      DATA (NHEL(I,2),I=1,5) / 1, 0,-1, 0, 0/
      DATA (NHEL(I,3),I=1,5) / 1, 0,-1, 0, 1/
      DATA (NHEL(I,4),I=1,5) / 1, 0, 1, 0,-1/
      DATA (NHEL(I,5),I=1,5) / 1, 0, 1, 0, 0/
      DATA (NHEL(I,6),I=1,5) / 1, 0, 1, 0, 1/
      DATA (NHEL(I,7),I=1,5) /-1, 0,-1, 0,-1/
      DATA (NHEL(I,8),I=1,5) /-1, 0,-1, 0, 0/
      DATA (NHEL(I,9),I=1,5) /-1, 0,-1, 0, 1/
      DATA (NHEL(I,10),I=1,5) /-1, 0, 1, 0,-1/
      DATA (NHEL(I,11),I=1,5) /-1, 0, 1, 0, 0/
      DATA (NHEL(I,12),I=1,5) /-1, 0, 1, 0, 1/
      DATA IDEN/ 2/
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
        IF(ZERO.ne.0d0) fk_ZERO = SIGN(MAX(ABS(ZERO), ABS(mdl_Mns
     $   *small_width_treatment)), ZERO)
        IF(ZERO.ne.0d0) fk_ZERO = SIGN(MAX(ABS(ZERO), ABS(mdl_mV
     $   *small_width_treatment)), ZERO)
        IF(ZERO.ne.0d0) fk_ZERO = SIGN(MAX(ABS(ZERO), ABS(mdl_mmu
     $   *small_width_treatment)), ZERO)
      endif
      AMP(:,:) = (0d0,0d0)
            CALL IXXXXX(P(0,1),MDL_MMU,+1,+1*IC(1),W(1,1))  !  count 9
      CALL IXXXXX(P(0,1),MDL_MMU,-1,+1*IC(1),W(1,2))  !  count 9
      CALL SXXXXX(P(0,2),-1*IC(2),W(1,3))  !  count 1
      CALL OXXXXX(P(0,3),MDL_MMU,+1,+1*IC(3),W(1,4))  !  count 9
      CALL OXXXXX(P(0,3),MDL_MMU,-1,+1*IC(3),W(1,5))  !  count 9
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6))  !  count 1
      CALL VXXXXX(P(0,5),MDL_MV,+1,+1*IC(5),W(1,7))  !  count 4
      CALL VXXXXX(P(0,5),MDL_MV, 0,+1*IC(5),W(1,8))  !  count 4
      CALL VXXXXX(P(0,5),MDL_MV,-1,+1*IC(5),W(1,9))  !  count 4
      CALL FFV1_2(W(1,1),W(1,7),GC_7,MDL_MMU,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_2(W(1,1),W(1,8),GC_7,MDL_MMU,FK_ZERO,W(1,11))  !  count 2
      CALL FFV1_2(W(1,1),W(1,9),GC_7,MDL_MMU,FK_ZERO,W(1,12))  !  count 2
      CALL FFV1_2(W(1,2),W(1,7),GC_7,MDL_MMU,FK_ZERO,W(1,13))  !  count 2
      CALL FFV1_2(W(1,2),W(1,8),GC_7,MDL_MMU,FK_ZERO,W(1,14))  !  count 2
      CALL FFV1_2(W(1,2),W(1,9),GC_7,MDL_MMU,FK_ZERO,W(1,15))  !  count 2
      CALL FORMFACTOR_VSS1P0_1(W(1,3),W(1,6),GC_1,ZERO,FK_ZERO,W(1,16))  !  count 24
      CALL FFV1P1N_1(W(1,4), W(1,16), GC_1, TMP(1))
      call CombineAmp(6,
     & (/6,5,4,12,11,10/), 
     & (/10,11,12,13,14,15/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,5), W(1,16), GC_1, TMP(1))
      call CombineAmp(6,
     & (/3,2,1,9,8,7/), 
     & (/10,11,12,13,14,15/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV1_1(W(1,4),W(1,7),GC_7,MDL_MMU,FK_ZERO,W(1,17))  !  count 2
      CALL FFV1_1(W(1,4),W(1,8),GC_7,MDL_MMU,FK_ZERO,W(1,18))  !  count 2
      CALL FFV1_1(W(1,4),W(1,9),GC_7,MDL_MMU,FK_ZERO,W(1,19))  !  count 2
      CALL FFV1_1(W(1,5),W(1,7),GC_7,MDL_MMU,FK_ZERO,W(1,20))  !  count 2
      CALL FFV1_1(W(1,5),W(1,8),GC_7,MDL_MMU,FK_ZERO,W(1,21))  !  count 2
      CALL FFV1_1(W(1,5),W(1,9),GC_7,MDL_MMU,FK_ZERO,W(1,22))  !  count 2
