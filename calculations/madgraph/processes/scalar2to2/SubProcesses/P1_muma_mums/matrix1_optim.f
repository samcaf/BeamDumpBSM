...
C     
C     Process: mu- a > mu- s WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL OXXXXX(P(0,3),MDL_MMU,+1,+1*IC(3),W(1,5))  !  count 8
      CALL OXXXXX(P(0,3),MDL_MMU,-1,+1*IC(3),W(1,6))  !  count 8
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,7))  !  count 10
      CALL FFV1_2(W(1,1),W(1,3),GC_1,MDL_MMU,FK_ZERO,W(1,8))  !  count 2
      CALL FFV1_2(W(1,1),W(1,4),GC_1,MDL_MMU,FK_ZERO,W(1,9))  !  count 2
      CALL FFV1_2(W(1,2),W(1,3),GC_1,MDL_MMU,FK_ZERO,W(1,10))  !  count 2
      CALL FFV1_2(W(1,2),W(1,4),GC_1,MDL_MMU,FK_ZERO,W(1,11))  !  count 2
      CALL FFS2P1N_1(W(1,5), W(1,7), GC_11, TMP(1))
      call CombineAmp(4,
     & (/4,2,8,6/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))
      CALL FFS2P1N_1(W(1,6), W(1,7), GC_11, TMP(1))
      call CombineAmp(4,
     & (/3,1,7,5/), 
     & (/8,9,10,11/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS2_2(W(1,1),W(1,7),GC_11,MDL_MMU,FK_ZERO,W(1,12))  !  count 4
      CALL FFS2_2(W(1,2),W(1,7),GC_11,MDL_MMU,FK_ZERO,W(1,13))  !  count 4
      CALL FFV1P1N_1(W(1,5), W(1,3), GC_1, TMP(1))
      call CombineAmp(2,
     & (/4,8/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,5), W(1,4), GC_1, TMP(1))
      call CombineAmp(2,
     & (/2,6/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,6), W(1,3), GC_1, TMP(1))
      call CombineAmp(2,
     & (/3,7/), 
     & (/12,13/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_1(W(1,6), W(1,4), GC_1, TMP(1))
      call CombineAmp(2,
     & (/1,5/), 
     & (/12,13/),
