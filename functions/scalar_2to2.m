scalar2to2["\!\(\*FractionBox[\(d\[Sigma]\), \(d \((p . k)\)\)]\)"] = 
...
scalar2to2["Squared, Spin-Averaged Matrix Element"] = 
...
scalar2to2["Squared, Spin-Averaged Matrix Element on-shell"] = 
    (-2*e^2*gmu^2*(26*mmu^8 + 2*mBSM^4*(mmu^2 - s2)*(mmu^2 - u2) - 
...
scalar2to2["\!\(\*SuperscriptBox[\(A\), \(2 \[Rule] 2\)]\)"] = 
...
scalar2to2["\!\(\*SuperscriptBox[\(A\), \(2 \[Rule] 2\)]\) near tmin"] = 
...
scalar2to2["\!\(\*SuperscriptBox[\(A\), \(2 \[Rule] 2\)]\) on-shell"] = 
