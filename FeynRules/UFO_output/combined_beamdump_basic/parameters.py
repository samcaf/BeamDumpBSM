...
Mns = Parameter(name = 'Mns',
                ...
                type = 'real',
                value = 131,
                texname = '\\text{$\\unicode{f7c9}\\unicode{f7c1}\\unicode{f7c9}\\unicode{f7c8}$SubscriptBox[$\\unicode{f7c9}$M$\\unicode{f7c0}$, SubscriptBox[$\\unicode{f7c9}$N$\\unicode{f7c0}$, $\\unicode{f7c9}$s$\\unicode{f7c0}$]]$\\unicode{f7c0}\\unicode{f7c0}$}',
                lhablock = 'MASS',
                lhacode = [ 994 ])
...
Mnf = Parameter(name = 'Mnf',
                ...
                type = 'real',
                value = 127,
                texname = '\\text{$\\unicode{f7c9}\\unicode{f7c1}\\unicode{f7c9}\\unicode{f7c8}$SubscriptBox[$\\unicode{f7c9}$M$\\unicode{f7c0}$, SubscriptBox[$\\unicode{f7c9}$N$\\unicode{f7c0}$, $\\unicode{f7c9}$f$\\unicode{f7c0}$]]$\\unicode{f7c0}\\unicode{f7c0}$}',
                lhablock = 'MASS',
                lhacode = [ 995 ])
